...
export default (Tree = function(x, y, z) {
  ...
  //TRUNK
  var trunkMat = new THREE.MeshLambertMaterial({ color: 0x9a6169, side: THREE.DoubleSide });
  ...
  //LEAVES
  var leavesMat = new THREE.MeshLambertMaterial({ color: 0x65bb61, side: THREE.DoubleSide });
