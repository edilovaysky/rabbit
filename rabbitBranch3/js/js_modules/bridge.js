...
export default (Bridge = function() {
  ...
  //bridge - wood block
  for (var i = 0; i < 15; i++) {
    var blockGeom = new THREE.BoxGeometry(10, 3, 50);
  ...
  this.rail_1.position.set(-90, -6, 172);
